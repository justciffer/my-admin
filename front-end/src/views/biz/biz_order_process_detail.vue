     ...
     <div>
        ...
        <Modal  title="编辑"  :mask-closable="false" :closable="false" v-model="modalAdd">
            <Form ref="formRef" :model="formValidate" :rules="ruleValidate" :label-width="80">
                ...
                <FormItem label="是否激活 0-否 1-是" prop="process_status">
                    <Input v-model="formValidate.process_status"></Input>
                </FormItem>
                ...
                <FormItem label="环节名称" prop="step_name">
                    <Input v-model="formValidate.step_name"></Input>
                </FormItem>
        ...
        <Modal  title="详情" v-model="modalDetail">
            <Form :model="formValidate" :label-width="80">
                ...
                <FormItem label="是否激活 0-否 1-是">
                    <Input v-model="formValidate.process_status" readonly></Input>
                </FormItem>
                <FormItem label="备注">
                ...
                <FormItem label="环节名称">
                    <Input v-model="formValidate.step_name" readonly></Input>
                </FormItem>
                <FormItem label="用户id">
        ...
        data () {
            return {
                ...
                ruleValidate: {
                    ...
                    process_status: [
                        { required: true, message: '是否激活 0-否 1-是为必填项'}
                    ],
                    remarks: [
